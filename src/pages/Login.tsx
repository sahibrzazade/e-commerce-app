    ...
    return (
        <div className="min-h-screen flex bg-black">
            ...
            <div className="hidden md:flex w-1/2 items-center justify-center bg-black">
                <img src="https://images.pexels.com/photos/1021693/pexels-photo-1021693.jpeg?_gl=1*oxbuq7*_ga*MzEzODIzNDA2LjE3NDk4OTU2Mzc.*_ga_8JE65Q40S6*czE3NTA2NjM5MzQkbzMkZzEkdDE3NTA2NjM5NTMkajQxJGwwJGgw" alt="Login Visual" className="max-w-full h-auto object-contain" />
            </div>
        </div>
    );
}
